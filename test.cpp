...
//format为自动选择格式%e或者%f（选输出宽度小的）精度是保留17位以内
...
static void  test_parse_number() {
    ...
    TEST_NUMBER(0.0, "-0");
    TEST_NUMBER(0.0, "-0.0");
    //TEST_ERROR(0.5E10, "0.5E10");整数部分如果是0开始，只能是单个0
    TEST_NUMBER(1.0, "1");
    TEST_NUMBER(-1.0, "-1");
    TEST_NUMBER(1.5, "1.5");
    TEST_NUMBER(-1.5, "-1.5");
...
/*#ifdef WIN32
    ...
    //_CrtSetBreakAlloc(87);  //在系统提示的第几次内存泄漏情况后，设置断点，可以更好的追踪泄漏源
#endif
*/
